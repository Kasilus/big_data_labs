...
forex_history = LOAD 'hdfs://hadoop-master:54310/user/hduser/results/check_results/csv/EURUSD_GBP_CHF_short.csv' USING
...
STORE result INTO 'hdfs://hadoop-master:54310/user/hduser/results/check_results/short' USING PigStorage (',');
